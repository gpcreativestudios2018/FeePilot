  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-10">
      ...
      <h1 className="text-3xl font-semibold tracking-tight text-purple-400 underline">
        eBay Fees Guide (Quick Overview)
      </h1>
      ...
      <section className="mt-8 space-y-3 text-white">
        ...
        <ul className="list-disc pl-6">
          <li>
            <strong>Final value fee:</strong> percentage varies by category/region.
          </li>
          <li>
            <strong>Payment processing:</strong> fixed + percent; varies by country/provider.
          </li>
          <li>
            <strong>Optional add-ons:</strong> listing upgrades, international, promos, etc.
          </li>
        </ul>
      </section>
      ...
      <section className="mt-8 space-y-3 text-white">
        ...
        <p>
          A quick sanity check many sellers use: <em>~12%–15% of price + shipping</em> for
          marketplace + processing, then add any optional upgrade costs. Exact rates vary by
          category/region.
        </p>
      </section>
