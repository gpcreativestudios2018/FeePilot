  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: { '@type': 'Answer', text: 'No. Calculations run in your browser. We do not store the numbers you enter.' },
    },
    {
      '@type': 'Question',
      name: 'Can I export results?',
      acceptedAnswer: { '@type': 'Answer', text: 'Yes. Use “Download CSV” to export fee breakdowns for spreadsheets and audits.' },
    },
    {
      '@type': 'Question',
      name: 'How do I share results?',
      acceptedAnswer: { '@type': 'Answer', text: 'Click “Copy link” to generate a shareable URL with your current calculator inputs.' },
    },
    {
      '@type': 'Question',
      name: 'What is Fee Pilot Pro?',
      acceptedAnswer: { '@type': 'Answer', text: 'Pro adds the Reverse Calculator so you can work backward from a target payout.' },
    },
  ],
};
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-10">
      ...
      <p className="mt-4 text-base text-gray-700" suppressHydrationWarning>
        This guide covers the core calculator, CSV export, sharing, and Pro features. If you’re new, start with the calculator, then explore Pro for advanced workflows.
      </p>
      ...
      <section className="mt-8 space-y-4">
        ...
        <ul className="list-disc pl-6 text-gray-700">
          <li>
            <strong>Calculator:</strong> <Link href={'/' as Route} className="underline">Enter amounts and see fee breakdowns</Link>.
          </li>
      ...
      <section className="mt-8 space-y-4">
        ...
        <ul className="list-disc pl-6 text-gray-700">
          <li>
            <strong>Overview:</strong> <Link href={'/pro' as Route} className="underline">See what’s in Pro</Link>.
          </li>
          <li>
            <strong>Reverse Calculator (beta):</strong> <Link href={'/pro/target' as Route} className="underline">Work backward from a target payout</Link>.
          </li>
        </ul>
      </section>
