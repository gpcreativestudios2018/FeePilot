...
export default function DepopFeesDoc() {
  return (
    <main className="mx-auto max-w-3xl px-4 py-10">
      ...
      <h1 className="text-3xl font-semibold tracking-tight">Depop Fees Guide (Quick Overview)</h1>

      <p className="mt-4 text-base text-gray-300" suppressHydrationWarning>
        Depop fees generally include a <strong>selling fee</strong> (often around 10% of the buyer’s total)
        and a <strong>payment processing fee</strong> (fixed + percent, varies by country and provider).
        Rates and rules can change—always confirm in Depop’s official help docs.
      </p>

      <section className="mt-8 space-y-3">
        <h2 className="text-xl font-medium">What’s included</h2>
        <ul className="list-disc pl-6 text-gray-300">
          <li><strong>Selling fee:</strong> commonly ~10% of item price + shipping paid by the buyer.</li>
